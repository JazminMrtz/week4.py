...
print("the max is",max(12,92))
print("the min is",min(12,92))

# Task 5: Round the number 12.5678 to 2 decimal places.
print("round 12.5678 to two decimal places",round(12.5678,2))
...
print("the floor of 15.7 is",floor(15.7))

# Task 8: Find the ceiling value of 15.2.
print("the ceil of 15.2 is",ceil(15.2))
